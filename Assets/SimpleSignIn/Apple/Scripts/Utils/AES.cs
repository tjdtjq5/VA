...
namespace Assets.SimpleSignIn.Apple.Scripts.Utils
{
    ...
    public static class AES
    {
        ...
        public static string Encrypt(byte[] value, string password)
        {
            ...
            var cryptoTransform = symmetricKey.CreateEncryptor(keyBytes, Encoding.UTF8.GetBytes(VIKey));
        ...
        public static string Decrypt(string value, string password)
        {
            ...
            var cryptoTransform = symmetricKey.CreateDecryptor(keyBytes, Encoding.UTF8.GetBytes(VIKey));
