...
namespace OPS.Obfuscator.Editor.Project.PostBuild
{
    public class PostBuildStep : AStep<PostAssemblyBuildOutput, PostBuildOutput>
    {
        // Constructor
        #region Constructor

        public PostBuildStep(EditorSettings _EditorSettings, BuildSettings _BuildSettings)
        {
        ...
        /// </summary>
        public new PostBuildDataContainer DataContainer
        {
            get
            {
                return (PostBuildDataContainer) base.DataContainer;
            }
            private set
            {
        ...
        private bool LoadDataContainer()
        {
            ...
            // Create
            this.DataContainer = new PostBuildDataContainer();
        ...
        private bool LoadComponents()
        {
            ...
            // Load Components
            this.DataContainer.ComponentList = OPS.Obfuscator.Editor.Project.PostBuild.Pipeline.Component.Helper.ComponentHelper.GetComponents();
        ...
        private bool LoadPipeline()
        {
            ...
            // Create
            this.Pipeline = new PostBuildPipeline(this);
