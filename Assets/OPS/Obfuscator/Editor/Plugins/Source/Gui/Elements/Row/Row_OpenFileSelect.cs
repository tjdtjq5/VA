...
{
    public class Row_OpenFileSelect : ARow<String>
    {
        public Row_OpenFileSelect(String _Text, String _Value)
            : base(_Text, _Value)
        {

        }

        public Row_OpenFileSelect(String _Text, ASettings _Settings, String _SettingsElementKey)
        ...
        protected override void OnGui(int _RowIndex)
        {
            ...
            {
                String var_FilePath = EditorUtility.OpenFilePanel(
                "Select a file path",
