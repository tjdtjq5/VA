...
{
    public class Row_TextBox : ARow<String>
    {
        public Row_TextBox(String _Text, String _Value)
            : base(_Text, _Value)
        {

        }

        public Row_TextBox(String _Text, ASettings _Settings, String _SettingsElementKey)
