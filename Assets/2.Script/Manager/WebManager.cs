...
public class WebManager
{
    ...
    private readonly string _webLoadingPrefabPath = "UIWebLoading";
    private UIWebLoading _webLoading;
    ...
    {
        if (_webLoading == null || _webLoading.gameObject.activeSelf == false)
            _webLoading = Managers.UI.ShopPopupUI<UIWebLoading>(_webLoadingPrefabPath, CanvasOrderType.Top);
    }
    private void HideWebLoading()
    {
        if (_webLoading != null && _webLoading.gameObject.activeSelf)
            _webLoading.ClosePopupUI();
    }
}
