...
public class BuildIOSWindow : EditorWindow
{
    ...
    static string _title = "IOS Build";
    ...
    static void OpenIOS()
    {
        var window = GetWindow<BuildIOSWindow>();
    ...
    void BuildLogSetting()
    {
        ...
        if (_logFoldout)
        {
            ...
            if (BuildLogDatas != null)
            {
                ...
                int count = Mathf.Min(datas.Count, 5);
            ...
            {
                _logScrollPos = EditorGUILayout.BeginScrollView(_logScrollPos, GUILayout.MinHeight(350));
                {
