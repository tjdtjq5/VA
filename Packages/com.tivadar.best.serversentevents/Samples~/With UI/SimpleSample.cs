...
namespace Best.ServerSentEvents.Examples
{
    class SimpleSample : Best.HTTP.Examples.Helpers.SampleBase
    {
...
#pragma warning restore
        ...
        {
            DateTimeData dtData = Best.HTTP.JSON.LitJson.JsonMapper.ToObject<DateTimeData>(message.Data);
